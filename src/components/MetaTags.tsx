...
const MetaTags: React.FC<MetaTagsProps> = ({
    ...
    useEffect(() => {
        ...
        const canonicalUrl = canonical || `https://sacredhearts.co.za${url}`;
        if (canonicalLink) {
        ...
        if (ogUrl) {
            ogUrl.setAttribute('content', `https://sacredhearts.co.za${url}`);
        } else {
            const meta = document.createElement('meta');
            meta.setAttribute('property', 'og:url');
            meta.setAttribute('content', `https://sacredhearts.co.za${url}`);
            document.head.appendChild(meta);
        }
    ...
    return (
        <>
            ...
            <meta property="og:url" content={`https://sacredhearts.co.za${url}`} />
            ...
            {/* Canonical URL */}
            <link rel="canonical" href={canonical || `https://sacredhearts.co.za${url}`} />
        </>
    );
};
